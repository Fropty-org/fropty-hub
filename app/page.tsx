...
import {
  Loader2, Gift, ArrowRight, Sparkles, Route, Users, LayoutList, Check,
  PiggyBank, Info, SlidersHorizontal, Quote, Coins, HelpCircle, BarChart2,
...
const MARQUEE_ITEMS: { Icon: LucideIcon; label: string }[] = [
  { Icon: Rocket,        label: "Prévia gratuita" },
  { Icon: Smartphone,    label: "Apps sob medida" },
  { Icon: Zap,           label: "Entrega em 3 dias" },
  { Icon: Wrench,        label: "Manutenção mensal" },
  { Icon: MessageCircle, label: "Suporte com tokens" },
  { Icon: CheckCircle,   label: "100% personalizado" },
  { Icon: Target,        label: "Sem taxa de entrada" },
  { Icon: LockOpen,      label: "Sem fidelidade inicial" },
  { Icon: Globe,         label: "Sites institucionais" },
  { Icon: Smartphone,    label: "Apps Android & iOS" },
];

const SERVICES: { num: string; Icon: LucideIcon; title: string; body: string; tags: string[] }[] = [
  {
    num: "01", Icon: Globe, title: "Sites Institucionais",
  ...
  {
    num: "02", Icon: Target, title: "Landing Pages",
  ...
  {
    num: "03", Icon: Smartphone, title: "Apps Mobile",
  ...
  {
    num: "04", Icon: LayoutDashboard, title: "SaaS & Sistemas Web",
  ...
  {
    num: "05", Icon: School, title: "Plataformas de Cursos",
  ...
  {
    num: "06", Icon: Lock, title: "Área de Membros",
  ...
  {
    num: "07", Icon: Plug, title: "Integrações Digitais",
  ...
  {
    num: "08", Icon: BarChart2, title: "Gestão de Tráfego",
...
const SEGMENTS_ROW_2: { Icon: LucideIcon; label: string }[] = [
  { Icon: Briefcase,    label: "Agências e Consultorias" },
  { Icon: Ruler,        label: "Engenharia e Arquitetura" },
  { Icon: PartyPopper,  label: "Eventos e Festas" },
  { Icon: ShoppingBag,  label: "Lojas e Varejo" },
  { Icon: Pill,         label: "Farmácias" },
  { Icon: Camera,       label: "Fotógrafos e Criativos" },
  { Icon: Calendar,     label: "Estúdios com Agendamento" },
  { Icon: Wrench,       label: "Empresas de Limpeza" },
  { Icon: Truck,        label: "Logística e Transporte" },
  { Icon: Smartphone,   label: "Startups & Apps" },
  { Icon: DollarSign,   label: "Fintech & SaaS" },
  { Icon: School,       label: "Educação & EAD" },
];
    ...
    <main style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--text)" }}>
        ...
        >
          ...
          <div className="order-2 flex-1 text-center lg:order-1 lg:text-left">
            ...
            <h1
              ...
              style={{ color: "var(--text)", fontFamily: "var(--font-dm-sans), sans-serif" }}
            >
              Seu app sob medida,{" "}
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-6 lg:justify-start lg:gap-8">
              {[
                { val: "R$0",    sub: "para começar",      Icon: Gift  },
                { val: "3 dias", sub: "para ver a prévia", Icon: Clock },
                { val: "100%",   sub: "personalizado",      Icon: Star  },
              ].map(({ val, sub, Icon }) => (
      ...
      <section id="solucoes" className="mx-auto max-w-6xl scroll-mt-20 px-6 py-20">
        <div className="mb-3 flex justify-center">
          <span className="section-chip">
            <Sparkles size={12} /> O que fazemos
          </span>
        </div>
      ...
      <section className="scroll-mt-20 py-20 overflow-hidden">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-3 flex justify-center">
            <span className="section-chip">
              <Users size={12} /> Atendemos todos os segmentos
            </span>
          </div>
          <h2
      ...
      >
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3">
            {[
              { Icon: Ticket,    title: "Básico: 4 · Pro: 8", body: "Todo mês você recebe tokens novos conforme seu plano." },
              { Icon: Hourglass, title: "Não acumulam",        body: "Tokens não usados expiram no fim do mês. Use sem medo." },
              { Icon: Wrench,    title: "Suporte e ajustes",   body: "Cada token vale um ajuste ou atendimento de suporte." },
            ].map(({ Icon, title, body }) => (
              <div
                key={title}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { value: "R$ 0",   label: "para ver a prévia",        Icon: Gift },
            { value: "3 dias", label: "para prévia ficar pronta", Icon: Clock },
            { value: "R$ 499", label: "app completo a partir de", Icon: Rocket },
            { value: "50%",    label: "de economia nos tokens",   Icon: PiggyBank },
